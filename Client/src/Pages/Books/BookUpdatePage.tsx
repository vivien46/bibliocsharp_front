        ...
        <div className="container mx-auto p-6">
            ...
            <form onSubmit={handleSubmit}>
                ...
                <div className="mb-4">
                    ...
                    {book.imageUrl ? (
                        <div>
                            <img src={`${import.meta.env.VITE_API_BASE_URL}/book/image/${book.imageUrl}`} alt={book.titre} className="mt-1 block w-1/4 rounded-md border-gray-300 shadow-sm focus:border-indigo-300 focus:ring focus:ring-indigo-200 focus:ring-opacity-50" />
